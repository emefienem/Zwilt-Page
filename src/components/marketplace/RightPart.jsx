...
const RightPart = ({ markets }) => {
  return (
    <div className="bg-white rounded-lg p-7">
      ...
      <div className="flex items-start w-full overflow-x-auto md:overflow-x-hidden scrollbar-hide">
        {markets.markets.map((market, index) => (
          <div
            key={index}
            className="flex-shrink-0 flex flex-col flex-wrap items-center gap-1 min-w-[100px] sm:min-w-[120px]"
          >
