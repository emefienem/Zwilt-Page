  ...
  return (
    <section className="flex justify-center mt-20">
      <div className="w-full text-[#202229] flex flex-col items-center ">
        ...
        <div className="w-full relative flex md:h-[64px] max-w-[680px] md:max-w-[570px] my-10">
          ...
          />
          <button className="relative right-8 h-full bg-[#FFBE2E] border-none md:w-[74px] w-[95px] md rounded-xl hover:bg-[#A285D0]">
            {/* Input image */}
