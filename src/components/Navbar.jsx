...
const Navbar = () => {
  ...
  return (
    <div
      className={`w-full bg-[#525AA0] rounded-2xl text-white shadow-xl flex justify-between p-5 relative ${
    ...
    >
      ...
      <div className="flex items-end justify-end">
        <div className="hidden lg:block relative bottom-3 ">
          ...
          <Link
            to="/"
            className="bg-white text-[#202229] border-none rounded-2xl hover:bg-[#A285D0] hover:text-white p-4"
          >
            Join Now
          </Link>
        </div>
        ...
        <div className="relative lg:hidden z-10">
          ...
          {menuOpen && (
            <ul className="fixed top-[86px] left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-1 py-2 pr-2 mt-4 shadow bg-[#525AA0] w-auto rounded-lg z-30 flex flex-col space-x-5">
