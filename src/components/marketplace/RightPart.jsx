...
const RightPart = ({ markets }) => {
  return (
    <div className="bg-white rounded-lg p-7">
      ...
      <div className="flex items-start gap-5 w-full overflow-x-auto md:overflow-x-hidden scrollbar-hide">
        {markets.markets.map((market, index) => (
          <div
            key={index}
            className="flex-shrink-0 flex flex-col flex-wrap items-center gap-2 min-w-[100px] sm:min-w-[120px]"
          >
            <div className="w-[86px] h-[76px] lg:w-[86px] lg:h-[86px] rounded-full flex items-center justify-center bg-[#F6F6F6] hover:scale-125 cursor-pointer">
