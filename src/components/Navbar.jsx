...
//           <ul
//             tabIndex={0}
//             className="flex md:hidden flex-row mt-3 z-[1] p-2 shadow bg-[#525AA0] w-52 "
//           >
//             <li>
//               <Link>Find Work</Link>
//             </li>
...
//               <Link
//                 to="/"
//                 className="bg-white text-[#202229] border-none rounded-2xl hover:bg-[#A285D0] hover:text-white"
//               >
//                 Join Now
//               </Link>
//             </li>
    ...
    <div className="w-full bg-[#525AA0] rounded-2xl text-white shadow-xl flex justify-between p-5">
      ...
      <div className="flex items-end justify-end">
        ...
        <div>
          ...
          {menuOpen && (
            <ul className="absolute right-0 mt-3 z-[1] p-2 shadow bg-[#525AA0] w-52 rounded-lg">
