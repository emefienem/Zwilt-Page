    ...
    >
      ...
      <div className="flex items-end justify-end">
        ...
        <div className="relative lg:hidden z-10">
          ...
          {menuOpen && (
            <ul className="fixed top-20 left-1/2 transform -translate-x-1/2 -translate-y-1/2 px-1 py-2 pr-2 mt-4 shadow bg-[#525AA0] w-auto rounded-lg z-30 flex flex-col space-x-5">
